...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color: #89300f;">
        <div class="container">
...
<div class="jumbotron text-center" style="background-color: #896510;">
        <h1>Travel Tales Flights</h1> 
        <p>We offer wide range of air travel to destination all over the United States</p> 
</div>
...
<footer class="container-fluid text-center" style="background-color: #0f5b56;">
